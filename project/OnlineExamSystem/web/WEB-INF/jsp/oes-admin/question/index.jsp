                            ...
                            <tbody>
                                <c:forEach items="${questions}" var="question">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" type="button" <c:if test="${question.owner.username != sessionScope.currentUser.username}">disabled</c:if>><span class="fa fa-gear"></span><span class="caret"></span></button>
